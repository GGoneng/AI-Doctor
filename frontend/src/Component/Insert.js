        ...
        <div className="flex items-center justify-center rounded-2xl bg-neutral-100/20 h-[350px] w-[848px] mt-20">
            <div className="flex flex-col items-center justify-center h-[90%] w-[90%] border-2 border-transparent rounded-2xl hover:border-dotted hover:rounded-2xl hover:border-gray-400 p-4">
                ...
                <div className="font-sans mt-10 w-[100%]"></div>
                    <input className="hidden" area-hidden="true" tabindex="-1" type="file" accept=".jpg,.jpeg,.png,.heic,.heif,.webp,.svg"></input>
                    <button className="flex items-center gap-2 px-4 py-2 rounded-lg bg-blue-500 text-white hover:bg-blue-600" type="button">
